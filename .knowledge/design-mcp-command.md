...
**Validation từ ECC:** ECC đã ship pattern này cho 7+ harnesses trong production (211k+ stars). ECC inject một dòng vào mỗi agent config, agent mới tự gọi guide() để onboard. Cross-harness bootstrap bằng one-liner là proven approach.
